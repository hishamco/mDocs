@page title=".NET Core CLI test communication protocol"
...
#### Test Execution
![Test Execution](/images/test-protocol/dotnet-test-execute.png)
...
#### Test discovery
![Test discovery](/images/test-protocol/dotnet-test-discover.png)
